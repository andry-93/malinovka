...
export const development = series(cleanFiles, smartGrid, parallel(views, styles, scripts, images, fonts, sprites, favs),
	parallel(watchCode, server));

export const prod = series(cleanFiles, smartGrid, serverConfig, views, styles, scripts, images, fonts, sprites, favs);
